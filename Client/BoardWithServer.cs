...
namespace Client
{
    public class BoardWithServer
    {
        ...
        private FormPlayWithServer formWithServer;
        ...
        ///</summary>
        public BoardWithServer(FormPlayWithServer formWithServer, Label playerLabel, Label serverLabel)
        {
            this.formWithServer = formWithServer;
            this.ChessBoard = formWithServer.panelBoard;
            ...
            this.Player = new List<Player>() {
                new Player(playerLabel.Text, Properties.Resources.o),
                new Player(serverLabel.Text, Properties.Resources.x)
            };
        ...
        private void changePlayer() {
            ...
            formWithServer.changeActivePictureBox(CurrentTurn);
        ...
        private void Btn_Click(object sender, EventArgs e) {
            ...
            {
                formWithServer.changeStatus("Hold your horses, champ. It's not your turn.");
                return;
            }
