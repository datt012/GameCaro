...
int main() {
	...
	while (1) {
		...
		if (sockEvent.lNetworkEvents & FD_READ) {
			...
			if (ret <= 0) {
				userSignout(&listClientConnect[index]);
				closesocket(listClientConnect[index].s);

				listClientConnect[index].s = listClientConnect[nEvents - 1].s;
				listClientConnect[index].isLogin = listClientConnect[nEvents - 1].isLogin;
				listClientConnect[index].portAddress = listClientConnect[nEvents - 1].portAddress;
				strcpy(listClientConnect[index].username, listClientConnect[nEvents - 1].username);
				strcpy(listClientConnect[index].IPAddress, listClientConnect[nEvents - 1].IPAddress);

				listClientConnect[nEvents - 1].s = 0;
				listClientConnect[nEvents - 1].isLogin = 0;
				listClientConnect[nEvents - 1].portAddress = 0;
				strcpy(listClientConnect[nEvents - 1].username, "");
				strcpy(listClientConnect[nEvents - 1].IPAddress, "");
